...
ALL: $(PREP) $(MAXMINPLOTS) $(NLSEED) $(BOKEHPLOT) $(NLWHEAT) $(MONTREAL_REGRESSION)
...
$(TEMPERATURE_CORNER_BROOK): $(PREP)
	./downloadData.py 6610 1995 2004

$(TEMPERATURE_SWIFT_CURRENT): $(PREP)
	./downloadData.py 6743 1995 2004

$(TEMPERATURE_PLUM_POINT): $(PREP)
	./downloadData.py 6688 1995 2004

$(TEMPERATURE_STJOHNS): $(PREP)
	./downloadData.py 6720 1995 2004

$(TEMPERATURE_CHARLESTON): $(PREP)
	./downloadData.py 6599 1995 2004

$(TEMPERATURE_GANDER): $(PREP)
...
$(TEMPERATURE_VICTORIA): $(PREP)
	./downloadData.py 51337 2016 2016

$(TEMPERATURE_MONTREAL): $(PREP)
	./downloadData.py 51157 2016 2016

$(TEMPERATURE_OTTAWA): $(PREP)
