...
""" Script for visualizing Min and Max tempreture 

    this function read data from csv files generated by download function 

Args:
	a list cantaining city names and years

Return:
	data/MinMaxPlot.png : png file including Min and Max temperature plots for Montreal, Otawwa and Vitoria 
