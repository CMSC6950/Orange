...
""" Script for visualizing regression for GDD year over year 

    read gdd data from csv file generated by gdd function


Return:
	data/LinReg.png:  relationship between total GDD vs year  
